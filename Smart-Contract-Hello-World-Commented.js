...
class HelloWorld {//Define the class object of our script
    ...
    greetings(city) {//creating the greetings class/function that can be called by the user.
        ...
        //Event.Trigger("greetings", "Here is " + city + ". Hello World! By " + this.visitor + ".")//Prints via RPC - need local node.
        return "greetings", "Here is " + city + ". Hello World! By " + this.visitor + ".";//Prints via execution - for web-wallet
    }
