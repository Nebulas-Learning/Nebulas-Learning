...
BankVaultContract.prototype = {//Define BankVaultContract function as a (prototype) object
  ...
  save: function (height) {//Define the save function
    ...
    deposit.expiryHeight = bk_height.plus(height);//Set the height of expiration ??
